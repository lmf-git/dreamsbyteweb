...
function Mobile({ extraClass, src, loading = false }) {
    return <svg className={`${extraClass} ${styles.herosimple_mobile}`} viewBox="0 0 258 520" preserveAspectRatio="xMidYMid meet">
        ...
        {loading && (
            <g>
                <path 
                    d="M244.491 487.233C244.491 501.067 233.262 512.281 219.407 512.281H38.5909C24.7379 512.281 13.5086 501.067 13.5086 487.233V32.6765C13.5086 18.8422 24.7379 7.62792 38.5909 7.62792H219.407C233.262 7.62792 244.491 18.8422 244.491 32.6765V487.233Z" 
