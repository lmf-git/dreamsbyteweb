export default function Nextjs({ extraClass = '' }) {
    return <svg className={extraClass} viewBox="0 0 512 512" fillRule="evenodd" clipRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2">
