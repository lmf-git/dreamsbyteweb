                    ...
                    <div className={styles.prose}>
                        ...
                        <div className={styles.footnotes}>
                            ...
                            <ol>
                                ...
                                <li>"OpenAI Benchmark Contamination: The Mirage of AI Coding Supremacy," <a href="https://decrypt.co/359012/openai-benchmark-measure-ai-coding-supremacy-contaminated" target="_blank" rel="noopener noreferrer">Decrypt</a>.</li>
                                <li>"Amazon&apos;s Mandatory Meeting on High Blast Radius AI Incidents," <a href="https://www.msn.com/en-us/news/technology/proceed-with-caution-elon-musk-offers-warning-after-amazon-reportedly-had-mandatory-meeting-to-address-high-blast-radius-and-ai-related-incidents/ar-AA1YqlRW" target="_blank" rel="noopener noreferrer">MSN / Business Insider</a>.</li>
                            </ol>
                        </div>
                    </div>
                </div>
