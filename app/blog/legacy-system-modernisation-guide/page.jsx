            ...
            <div className={styles.container}>
                ...
                <div className={styles.content}>
                    <div className={styles.prose}>
                        ...
                        <ul className={styles.list}>
                            <li className={styles.listItem}><strong>A Happier, More Productive Team:</strong> When you replace a tool your team hates with one they love, their efficiency and morale skyrockets.</li>
                            ...
                            <li className={styles.listItem}><strong>Peace of Mind:</strong> Knowing your critical business data is secure, backed up, and running on a stable, modern platform is invaluable.</li>
                        </ul>
