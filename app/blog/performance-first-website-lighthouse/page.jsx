                ...
                <div className={styles.prose}>
                    ...
                    <ul className={styles.list}>
                        <li className={styles.listItem}><strong>Next-Gen Formats:</strong> We serve all images in modern, highly-compressed formats like WebP.</li>
                                                    <li className={styles.listItem}><strong>Responsive Sizing:</strong> We generate multiple sizes of each image and use the <code>&lt;picture&gt;</code> element or <code>srcset</code> attribute to ensure that a mobile device downloads a small, mobile-sized image, not a huge desktop-sized one.</li>                        <li className={styles.listItem}><strong>Lazy Loading:</strong> Images that are below the fold (not visible on the screen) are not loaded until the user scrolls down to them. This dramatically speeds up the initial page load.</li>
                    </ul>
